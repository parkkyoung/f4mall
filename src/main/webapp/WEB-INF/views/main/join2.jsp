...
<!-- font-awesome -->
<link href="${ pageContext.request.contextPath }/resources/f4/css/main/menu.css" rel="stylesheet">
<!-- mobile left menu -->
<link href="${ pageContext.request.contextPath }/resources/f4/css/main/common.css" rel="stylesheet">
<!-- customizing -->
...
<!-- sweet alert -->
<script src="${ pageContext.request.contextPath }/resources/f4/js/main/menu.js"></script>
<!-- mobile left menu -->
<script src="${ pageContext.request.contextPath }/resources/f4/js/main/common.js"></script>
<!-- customizing -->
