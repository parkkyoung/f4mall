...
<!-- font-awesome -->
<link href="${ pageContext.request.contextPath }/resources/f4/css/menu.css" rel="stylesheet">
<!-- mobile left menu -->
<link href="${ pageContext.request.contextPath }/resources/f4/css/common.css" rel="stylesheet">
<!-- customizing -->
...
<!-- sweet alert -->
<script src="${ pageContext.request.contextPath }/resources/f4/js/menu.js"></script>
<!-- mobile left menu -->
<script src="${ pageContext.request.contextPath }/resources/f4/js/common.js"></script>
<!-- customizing -->
...
<script>
	...
	function join(f) {
		...
		var m1_pwd = f.m1_pwd.value.trim();
...
<body>
	...
	<nav id="c-menu--push-left" class="c-menu c-menu--push-left">
		...
		<button type="button" class="btnClose c-menu__close">GNB
			Close</button>
	...
	<div id="wrap" class="o-wrapper">
		...
		<header id="header">
			...
			<div class="head">
				...
				<h1>
					<a href="main.jsp" title="HOME">F4 Mall</a>
				</h1>
				<div class="util">
					...
					<!-- 미 로그인 시에 노출 -->
					<a href="../admin/main.jsp"><i class="fa fa-wrench fa-w-16"></i></a>
					<!-- 관리자 접속시에 노출 -->
				</div>
			</div>
			...
			<div class="foot">
				<div class="row">
					...
					<div class="footAbout mt40 col-lg-3 col-md-6 col-sm-12">
						<h3>F4 Mall</h3>
						<p>고구려는 부여의 왕자라 전해지는 고주몽이 건국하였다. 부여와의 투쟁 속에서 성장하였고, 산간지대에 위치한
							고구려의 지리적 사정으로 인한 부족한 식량 사정과 부족한 논밭 문제를 해결하기 위해 주변의 비옥한 영토를 정복하는
							적극적인 정복 활동과 대규모 정복전쟁을 벌였다. 중국 사서에서는 약탈로 인해 신나라 왕망의 분노를...</p>
						<div class="snsBox">
					...
					<div class="footAdrs mt40 col-lg-3 col-md-6 col-sm-12">
						<h4>ADDRESS</h4>
						<address>
							<span>COMPANY : F4 Entertainment</span> <span>OWNER :
								Junpyo Gu</span> <span>CALL CENTER : 1577-1577</span> <span>ADDRESS
								: 평양 직할시 정은동 주석궁 401호</span> <span>LICENSE NUMBER :
								[012-34-56789]</span> <strong>Copyright (c) by f4mall.com. All
					...
					<div class="footCall mt40 col-lg-3 col-md-6 col-sm-12">
						<h4>GET IN TOUCH</h4>
						<div>
							<i class="fa fa-home"></i><span>평양 직할시 정은동 주석궁 401호</span>
						</div>
						<div>
							<i class="fa fa-phone"></i><span>1577-1577</span>
						</div>
						<div>
							<i class="fa fa-envelope"></i><span>rudals0731@naver.com</span>
						</div>
					</div>
					<!-- //call -->
				</div>
